...
export const GET_DISLICENSE = "GET_DISLICENSE";
export const GET_UPDATE_TRACK = "GET_UPDATE_TRACK";
export const SEARCH_REGISTRATION = "SEARCH_REGISTRATION";
export const FILTER_REGISTRATION = "FILTER_REGISTRATION";
export const FILTER_TRACK = "FILTER_TRACK";
//export reducer type dayoff
export const REQUEST_GET_REGISTRATION = "REQUEST_GET_REGISTRATION";
export const REQUEST_FILTER_REGIS = "REQUEST_FILTER_REGIS";
