...
class ListYearComponent extends Component {
          ...
          <div className="wrap-form">
            <div className="p-title">
              <div className="menu-list">
                <div className="title">
                  <h3 className="heading-3">Nghỉ phép năm</h3>
                </div>
              </div>
              <form onSubmit={this.onSubmit}>
                <input type="text" className="p-search" name="year" value={this.state.year} onChange={this.onhandleChange} />
                {/* <DatePicker
                  className="ip-date"
                ...
                <tbody>
                  {
                    this.props.data.map(data => (
                      <tr key={data.id} >
                        ...
                        <td className="description">{data.attributes.at_time}
                          {
...
export default ListYearComponent;